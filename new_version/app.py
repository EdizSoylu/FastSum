...
from modules import note_handler, pdf_handler
...
class Project:
    ...
    def new_note(self, note_name):
        ...
        # Init note tab
        self.note = note_handler.Note(self.root, note_name)
        self.note.note_frame.grid(row=0, column=1, sticky="w")

        if self.pdf_tab is not None:
            # Set ref of pdf instance
            self.pdf_tab.note = self.note
    ...
    def open_note(self, name):
        ...
        # Init new note with contents from save
